  ...
  return (
    <section className="bg-base-200 py-16 px-6 text-center rounded-xl shadow-md mx-4 md:mx-16 mt-12">
      ...
      <Link to="/auth/register">
        <button className="bg-primary cursor-pointer text-white font-semibold px-8 py-3 rounded-full shadow-md hover:bg-amber-500 hover:scale-105 transition transform duration-300">
          Join Now
        </button>
      </Link>
    </section>
